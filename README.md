...
Goal: Prototype to automatically detect and segment trees. The city of Lüneburg is interested in a fully usable application to provide the green coverage by trees based on the aerial imagery which can adapted based on this prototype.
